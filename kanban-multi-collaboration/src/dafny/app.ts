...
interface AppInternal { _dafny: unknown; KanbanDomain: unknown; KanbanMultiCollaboration: unknown; KanbanAppCore: unknown; }
...
const App = {
  ...
  // AppCore functions
  MakeClientState: (baseVersion: number, present: DafnyModel, pending: Action[]): DafnyClientState => KanbanAppCore.__default.MakeClientState(new BigNumber(baseVersion), present, _dafny.Seq.of(...(pending || []).map((x: any) => actionFromJson(x)))),
  Init: (): DafnyServerState => KanbanAppCore.__default.Init(),
  InitServerWithModel: (initModel: DafnyModel): DafnyServerState => KanbanAppCore.__default.InitServerWithModel(initModel),
  InitClientFromServer: (server: DafnyServerState): DafnyClientState => KanbanAppCore.__default.InitClientFromServer(server),
  ClientLocalDispatch: (client: DafnyClientState, action: DafnyAction): DafnyClientState => KanbanAppCore.__default.ClientLocalDispatch(client, action),
  HandleRealtimeUpdate: (client: DafnyClientState, serverVersion: number, serverModel: DafnyModel): DafnyClientState => KanbanAppCore.__default.HandleRealtimeUpdate(client, new BigNumber(serverVersion), serverModel),
  ClientAcceptReply: (client: DafnyClientState, newVersion: number, newPresent: DafnyModel): DafnyClientState => KanbanAppCore.__default.ClientAcceptReply(client, new BigNumber(newVersion), newPresent),
  Sync: (server: DafnyServerState): DafnyClientState => KanbanAppCore.__default.Sync(server),
  ServerVersion: (server: DafnyServerState): number => toNumber(KanbanAppCore.__default.ServerVersion(server)),
  ServerModel: (server: DafnyServerState): DafnyModel => KanbanAppCore.__default.ServerModel(server),
  AuditLength: (server: DafnyServerState): number => toNumber(KanbanAppCore.__default.AuditLength(server)),
  PendingCount: (client: DafnyClientState): number => toNumber(KanbanAppCore.__default.PendingCount(client)),
  ClientModel: (client: DafnyClientState): DafnyModel => KanbanAppCore.__default.ClientModel(client),
  ClientVersion: (client: DafnyClientState): number => toNumber(KanbanAppCore.__default.ClientVersion(client)),
  IsAccepted: (reply: DafnyReply): boolean => KanbanAppCore.__default.IsAccepted(reply),
  IsRejected: (reply: DafnyReply): boolean => KanbanAppCore.__default.IsRejected(reply),
  ...
  _internal: { _dafny, KanbanDomain, KanbanMultiCollaboration, KanbanAppCore } as AppInternal,
};
