...
let KanbanRealtimeCollaboration = (function() {
  let $module = {};

  $module.__default = class __default {
    constructor () {
      this._tname = "KanbanRealtimeCollaboration._default";
    }
    _parentTraits() {
      return [];
    }
    static InitClient(version, model) {
      return KanbanRealtimeCollaboration.ClientState.create_ClientState(version, model, _dafny.Seq.of(), KanbanRealtimeCollaboration.ClientMode.create_Normal());
    };
    static Sync(server) {
      return KanbanRealtimeCollaboration.ClientState.create_ClientState(KanbanMultiCollaboration.__default.Version(server), (server).dtor_present, _dafny.Seq.of(), KanbanRealtimeCollaboration.ClientMode.create_Normal());
    };
    static LocalDispatch(client, action) {
      ...
      let _source0 = _0_result;
      {
        if (_source0.is_Ok) {
          ...
          return KanbanRealtimeCollaboration.ClientState.create_ClientState((client).dtor_baseVersion, _1_newModel, _dafny.Seq.Concat((client).dtor_pending, _dafny.Seq.of(action)), (client).dtor_mode);
        }
      }
      {
        return KanbanRealtimeCollaboration.ClientState.create_ClientState((client).dtor_baseVersion, (client).dtor_present, _dafny.Seq.Concat((client).dtor_pending, _dafny.Seq.of(action)), (client).dtor_mode);
      }
    };
    static HandleRealtimeUpdate(client, serverVersion, serverModel) {
      if (_dafny.areEqual((client).dtor_mode, KanbanRealtimeCollaboration.ClientMode.create_Flushing())) {
        return client;
      } else if (((client).dtor_baseVersion).isLessThan(serverVersion)) {
        return KanbanRealtimeCollaboration.ClientState.create_ClientState(serverVersion, serverModel, _dafny.Seq.of(), KanbanRealtimeCollaboration.ClientMode.create_Normal());
      } else {
        return client;
      }
    };
    static EnterFlushMode(client) {
      return KanbanRealtimeCollaboration.ClientState.create_ClientState((client).dtor_baseVersion, (client).dtor_present, (client).dtor_pending, KanbanRealtimeCollaboration.ClientMode.create_Flushing());
    };
    static ExitFlushMode(client, server) {
      return KanbanRealtimeCollaboration.__default.Sync(server);
    };
    static FlushOne(server, client) {
      if ((new BigNumber(((client).dtor_pending).length)).isEqualTo(_dafny.ZERO)) {
        return KanbanRealtimeCollaboration.Option.create_None();
      } else {
        ...
        let _source0 = _3_reply;
        {
          if (_source0.is_Accepted) {
            ...
            let _8_newClient = KanbanRealtimeCollaboration.ClientState.create_ClientState(_4_newVersion, _5_newPresent, _1_rest, (client).dtor_mode);
            return KanbanRealtimeCollaboration.Option.create_Some(KanbanRealtimeCollaboration.FlushOneResult.create_FlushOneResult(_2_newServer, _8_newClient, _3_reply));
          }
        }
        {
          let _9_reason = (_source0).reason;
          let _10_rebased = (_source0).rebased;
          let _11_newClient = KanbanRealtimeCollaboration.ClientState.create_ClientState(KanbanMultiCollaboration.__default.Version(server), (server).dtor_present, _1_rest, (client).dtor_mode);
          return KanbanRealtimeCollaboration.Option.create_Some(KanbanRealtimeCollaboration.FlushOneResult.create_FlushOneResult(_2_newServer, _11_newClient, _3_reply));
        }
      }
    };
    static FlushAll(server, client) {
      if ((new BigNumber(((client).dtor_pending).length)).isEqualTo(_dafny.ZERO)) {
        return KanbanRealtimeCollaboration.FlushAllResult.create_FlushAllResult(server, client, _dafny.Seq.of());
      } else {
        let _0_flushResult = KanbanRealtimeCollaboration.__default.FlushOne(server, client);
        if ((_0_flushResult).is_None) {
          ...
          if ((((_1_result).dtor_client).dtor_baseVersion).isLessThanOrEqualTo(KanbanMultiCollaboration.__default.Version((_1_result).dtor_server))) {
            let _2_rest = KanbanRealtimeCollaboration.__default.FlushAll((_1_result).dtor_server, (_1_result).dtor_client);
            return KanbanRealtimeCollaboration.FlushAllResult.create_FlushAllResult((_2_rest).dtor_server, (_2_rest).dtor_client, _dafny.Seq.Concat(_dafny.Seq.of((_1_result).dtor_reply), (_2_rest).dtor_replies));
          } else {
            return KanbanRealtimeCollaboration.FlushAllResult.create_FlushAllResult((_1_result).dtor_server, (_1_result).dtor_client, _dafny.Seq.of((_1_result).dtor_reply));
          }
        }
      }
    };
    static FlushCycle(server, client) {
      let _0_flushingClient = KanbanRealtimeCollaboration.__default.EnterFlushMode(client);
      let _1_flushResult = KanbanRealtimeCollaboration.__default.FlushAll(server, _0_flushingClient);
      let _2_finalClient = KanbanRealtimeCollaboration.__default.ExitFlushMode((_1_flushResult).dtor_client, (_1_flushResult).dtor_server);
      return KanbanRealtimeCollaboration.FlushCycleResult.create_FlushCycleResult((_1_flushResult).dtor_server, _2_finalClient, (_1_flushResult).dtor_replies);
    };
    static FlushWithRealtimeEvents(server, client, events) {
      let _0_flushingClient = KanbanRealtimeCollaboration.__default.EnterFlushMode(client);
      let _1_afterEvents = KanbanRealtimeCollaboration.__default.ProcessRealtimeEvents(_0_flushingClient, events);
      let _2_flushResult = KanbanRealtimeCollaboration.__default.FlushAll(server, _1_afterEvents);
      let _3_finalClient = KanbanRealtimeCollaboration.__default.ExitFlushMode((_2_flushResult).dtor_client, (_2_flushResult).dtor_server);
      return KanbanRealtimeCollaboration.FlushCycleResult.create_FlushCycleResult((_2_flushResult).dtor_server, _3_finalClient, (_2_flushResult).dtor_replies);
    };
    static ProcessRealtimeEvents(client, events) {
      TAIL_CALL_START: while (true) {
        if ((new BigNumber((events).length)).isEqualTo(_dafny.ZERO)) {
          return client;
        } else {
          let _0_e = (events)[_dafny.ZERO];
          let _1_newClient = KanbanRealtimeCollaboration.__default.HandleRealtimeUpdate(client, (_0_e).dtor_version, (_0_e).dtor_model);
          let _in0 = _1_newClient;
          let _in1 = (events).slice(_dafny.ONE);
          client = _in0;
          events = _in1;
          continue TAIL_CALL_START;
        }
  ...
  $module.Option = class Option {
    ...
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.Option.None";
      } else if (this.$tag === 1) {
        return "KanbanRealtimeCollaboration.Option.Some" + "(" + _dafny.toString(this.value) + ")";
      } else  {
        return "<unexpected>";
      }
    }
  ...
  $module.ClientMode = class ClientMode {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_Normal() {
      let $dt = new ClientMode(0);
      return $dt;
    }
    static create_Flushing() {
      let $dt = new ClientMode(1);
      return $dt;
    }
    get is_Normal() { return this.$tag === 0; }
    get is_Flushing() { return this.$tag === 1; }
    static get AllSingletonConstructors() {
      return this.AllSingletonConstructors_();
    }
    static *AllSingletonConstructors_() {
      yield ClientMode.create_Normal();
      yield ClientMode.create_Flushing();
    }
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.ClientMode.Normal";
      } else if (this.$tag === 1) {
        return "KanbanRealtimeCollaboration.ClientMode.Flushing";
      } else  {
        return "<unexpected>";
      }
    }
    ...
    static Default() {
      return KanbanRealtimeCollaboration.ClientMode.create_Normal();
    }
    static Rtd() {
      return class {
        static get Default() {
          return ClientMode.Default();
        }
      };
    }
  }
  ...
  $module.ClientState = class ClientState {
    ...
    static create_ClientState(baseVersion, present, pending, mode) {
    ...
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.ClientState.ClientState" + "(" + _dafny.toString(this.baseVersion) + ", " + _dafny.toString(this.present) + ", " + _dafny.toString(this.pending) + ", " + _dafny.toString(this.mode) + ")";
      } else  {
        return "<unexpected>";
      }
    }
    equals(other) {
      if (this === other) {
        ...
        return other.$tag === 0 && _dafny.areEqual(this.baseVersion, other.baseVersion) && _dafny.areEqual(this.present, other.present) && _dafny.areEqual(this.pending, other.pending) && _dafny.areEqual(this.mode, other.mode);
      } else  {
        return false; // unexpected
      }
    }
    static Default() {
      return KanbanRealtimeCollaboration.ClientState.create_ClientState(_dafny.ZERO, KanbanDomain.Model.Default(), _dafny.Seq.of(), KanbanRealtimeCollaboration.ClientMode.Default());
    }
    static Rtd() {
      return class {
        static get Default() {
  ...
  $module.FlushOneResult = class FlushOneResult {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_FlushOneResult(server, client, reply) {
      let $dt = new FlushOneResult(0);
      $dt.server = server;
      $dt.client = client;
      $dt.reply = reply;
      return $dt;
    }
    get is_FlushOneResult() { return this.$tag === 0; }
    get dtor_server() { return this.server; }
    get dtor_client() { return this.client; }
    get dtor_reply() { return this.reply; }
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.FlushOneResult.FlushOneResult" + "(" + _dafny.toString(this.server) + ", " + _dafny.toString(this.client) + ", " + _dafny.toString(this.reply) + ")";
      } else  {
        return "<unexpected>";
      }
    }
    ...
    static Default() {
      return KanbanRealtimeCollaboration.FlushOneResult.create_FlushOneResult(KanbanMultiCollaboration.ServerState.Default(), KanbanRealtimeCollaboration.ClientState.Default(), KanbanMultiCollaboration.Reply.Default());
    }
    static Rtd() {
      return class {
        static get Default() {
          return FlushOneResult.Default();
        }
      };
    }
  }
  ...
  $module.FlushAllResult = class FlushAllResult {
    ...
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.FlushAllResult.FlushAllResult" + "(" + _dafny.toString(this.server) + ", " + _dafny.toString(this.client) + ", " + _dafny.toString(this.replies) + ")";
      } else  {
        return "<unexpected>";
      }
    }
    ...
    static Default() {
      return KanbanRealtimeCollaboration.FlushAllResult.create_FlushAllResult(KanbanMultiCollaboration.ServerState.Default(), KanbanRealtimeCollaboration.ClientState.Default(), _dafny.Seq.of());
    }
    static Rtd() {
      return class {
        static get Default() {
  ...
  $module.FlushCycleResult = class FlushCycleResult {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_FlushCycleResult(server, client, replies) {
      let $dt = new FlushCycleResult(0);
      $dt.server = server;
      $dt.client = client;
      $dt.replies = replies;
      return $dt;
    }
    get is_FlushCycleResult() { return this.$tag === 0; }
    get dtor_server() { return this.server; }
    get dtor_client() { return this.client; }
    get dtor_replies() { return this.replies; }
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.FlushCycleResult.FlushCycleResult" + "(" + _dafny.toString(this.server) + ", " + _dafny.toString(this.client) + ", " + _dafny.toString(this.replies) + ")";
      } else  {
        return "<unexpected>";
      }
    }
    ...
    static Default() {
      return KanbanRealtimeCollaboration.FlushCycleResult.create_FlushCycleResult(KanbanMultiCollaboration.ServerState.Default(), KanbanRealtimeCollaboration.ClientState.Default(), _dafny.Seq.of());
    }
    static Rtd() {
      return class {
        static get Default() {
          return FlushCycleResult.Default();
        }
      };
    }
  }

  $module.RealtimeEvent = class RealtimeEvent {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_RealtimeEvent(version, model) {
      let $dt = new RealtimeEvent(0);
      $dt.version = version;
      $dt.model = model;
      return $dt;
    }
    get is_RealtimeEvent() { return this.$tag === 0; }
    get dtor_version() { return this.version; }
    get dtor_model() { return this.model; }
    toString() {
      if (this.$tag === 0) {
        return "KanbanRealtimeCollaboration.RealtimeEvent.RealtimeEvent" + "(" + _dafny.toString(this.version) + ", " + _dafny.toString(this.model) + ")";
      } else  {
        return "<unexpected>";
      }
    }
    ...
    static Default() {
      return KanbanRealtimeCollaboration.RealtimeEvent.create_RealtimeEvent(_dafny.ZERO, KanbanDomain.Model.Default());
    }
    static Rtd() {
      return class {
        static get Default() {
          return RealtimeEvent.Default();
        }
      };
    }
  }
  return $module;
})(); // end of module KanbanRealtimeCollaboration
