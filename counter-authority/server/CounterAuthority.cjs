...
let CounterDomain = (function() {
  ...
  $module.TryStepResult = class TryStepResult {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_Ok(m_k) {
      let $dt = new TryStepResult(0);
      $dt.m_k = m_k;
      return $dt;
    }
    static create_Invalid(msg) {
      let $dt = new TryStepResult(1);
      $dt.msg = msg;
      return $dt;
    }
    get is_Ok() { return this.$tag === 0; }
    get is_Invalid() { return this.$tag === 1; }
    get dtor_m_k() { return this.m_k; }
    ...
    equals(other) {
      if (this === other) {
        ...
        return other.$tag === 0 && _dafny.areEqual(this.m_k, other.m_k);
      } else if (this.$tag === 1) {
...
let CounterServer = (function() {
  ...
  $module.FailureReason = class FailureReason {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_Stale() {
      let $dt = new FailureReason(0);
      return $dt;
    }
    static create_InvalidAction(msg) {
      let $dt = new FailureReason(1);
      $dt.msg = msg;
      return $dt;
    }
    get is_Stale() { return this.$tag === 0; }
    get is_InvalidAction() { return this.$tag === 1; }
    get dtor_msg() { return this.msg; }
    toString() {
      if (this.$tag === 0) {
  ...
  $module.Result = class Result {
    ...
    static create_Success(present) {
      let $dt = new Result(0);
      $dt.present = present;
      return $dt;
    }
    static create_Failure(reason) {
      let $dt = new Result(1);
      $dt.reason = reason;
      return $dt;
    }
    ...
    equals(other) {
      if (this === other) {
        ...
        return other.$tag === 0 && _dafny.areEqual(this.present, other.present);
      } else if (this.$tag === 1) {
  ...
  $module.Response = class Response {
    ...
    static create_Response(ver, res) {
      let $dt = new Response(0);
      $dt.ver = ver;
      $dt.res = res;
      return $dt;
    }
    get is_Response() { return this.$tag === 0; }
    get dtor_ver() { return this.ver; }
    ...
    equals(other) {
      if (this === other) {
        ...
        return other.$tag === 0 && _dafny.areEqual(this.ver, other.ver) && _dafny.areEqual(this.res, other.res);
      } else  {
        return false; // unexpected
      }
    }
  ...
  $module.SyncResponse = class SyncResponse {
    constructor(tag) {
      this.$tag = tag;
    }
    static create_SyncResponse(ver, present) {
      let $dt = new SyncResponse(0);
      $dt.ver = ver;
      $dt.present = present;
      return $dt;
    }
    get is_SyncResponse() { return this.$tag === 0; }
    get dtor_ver() { return this.ver; }
    get dtor_present() { return this.present; }
    toString() {
      if (this.$tag === 0) {
    ...
    equals(other) {
      if (this === other) {
        ...
        return other.$tag === 0 && _dafny.areEqual(this.ver, other.ver) && _dafny.areEqual(this.present, other.present);
      } else  {
        return false; // unexpected
      }
    }
...
let AppCore = (function() {
  ...
  $module.__default = class __default {
    ...
    static IsSuccess(r) {
      return ((r).dtor_res).is_Success;
    };
    static IsStale(r) {
      return (((r).dtor_res).is_Failure) && ((((r).dtor_res).dtor_reason).is_Stale);
    };
    static IsInvalid(r) {
      return (((r).dtor_res).is_Failure) && ((((r).dtor_res).dtor_reason).is_InvalidAction);
    };
    static GetInvalidMsg(r) {
      return (((r).dtor_res).dtor_reason).dtor_msg;
    };
    static GetResponseVersion(r) {
      return (r).dtor_ver;
    };
    static GetSuccessValue(r) {
      return ((r).dtor_res).dtor_present;
    };
  };
  return $module;
