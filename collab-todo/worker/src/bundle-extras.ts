...
// These provide a convenient JS interface for the Cloudflare Worker.
// TODO: Add proper TypeScript types when CloudflareEmitter is fixed
...
import {
  ...
  actionToJson,
  dafnyStringToJs,
} from './dafny-bundle-multi'

// Re-export modelToJson from the single dispatch bundle
export { modelToJson } from './dafny-bundle'
