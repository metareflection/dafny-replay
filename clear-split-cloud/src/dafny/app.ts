...
const App = {
  ...
  // AppCore functions
  EffectInit: (version: number, model: DafnyModel): DafnyEffectState => ClearSplitEffectAppCore.__default.EffectInit(new BigNumber(version), model),
  EffectStep: (es: DafnyEffectState, event: DafnyEvent): DafnyTuple2<DafnyEffectState, DafnyCommand> => ClearSplitEffectAppCore.__default.EffectStep(es, event),
  EffectIsOnline: (es: DafnyEffectState): boolean => ClearSplitEffectAppCore.__default.EffectIsOnline(es),
  EffectIsIdle: (es: DafnyEffectState): boolean => ClearSplitEffectAppCore.__default.EffectIsIdle(es),
  EffectHasPending: (es: DafnyEffectState): boolean => ClearSplitEffectAppCore.__default.EffectHasPending(es),
  EffectPendingCount: (es: DafnyEffectState): number => toNumber(ClearSplitEffectAppCore.__default.EffectPendingCount(es)),
  EffectGetClient: (es: DafnyEffectState): DafnyClientState => ClearSplitEffectAppCore.__default.EffectGetClient(es),
  EffectGetServerVersion: (es: DafnyEffectState): number => toNumber(ClearSplitEffectAppCore.__default.EffectGetServerVersion(es)),
  EffectUserAction: (action: DafnyAction): DafnyEvent => ClearSplitEffectAppCore.__default.EffectUserAction(action),
  EffectDispatchAccepted: (version: number, model: DafnyModel): DafnyEvent => ClearSplitEffectAppCore.__default.EffectDispatchAccepted(new BigNumber(version), model),
  EffectDispatchConflict: (version: number, model: DafnyModel): DafnyEvent => ClearSplitEffectAppCore.__default.EffectDispatchConflict(new BigNumber(version), model),
  EffectDispatchRejected: (version: number, model: DafnyModel): DafnyEvent => ClearSplitEffectAppCore.__default.EffectDispatchRejected(new BigNumber(version), model),
  EffectNetworkError: (): DafnyEvent => ClearSplitEffectAppCore.__default.EffectNetworkError(),
  EffectNetworkRestored: (): DafnyEvent => ClearSplitEffectAppCore.__default.EffectNetworkRestored(),
  EffectManualGoOffline: (): DafnyEvent => ClearSplitEffectAppCore.__default.EffectManualGoOffline(),
  EffectManualGoOnline: (): DafnyEvent => ClearSplitEffectAppCore.__default.EffectManualGoOnline(),
  EffectTick: (): DafnyEvent => ClearSplitEffectAppCore.__default.EffectTick(),
  EffectIsNoOp: (cmd: DafnyCommand): boolean => ClearSplitEffectAppCore.__default.EffectIsNoOp(cmd),
  EffectIsSendDispatch: (cmd: DafnyCommand): boolean => ClearSplitEffectAppCore.__default.EffectIsSendDispatch(cmd),
  EffectGetBaseVersion: (cmd: DafnyCommand): number => toNumber(ClearSplitEffectAppCore.__default.EffectGetBaseVersion(cmd)),
  EffectGetAction: (cmd: DafnyCommand): DafnyAction => ClearSplitEffectAppCore.__default.EffectGetAction(cmd),
  MakeGroupEntry: (groupName: string, displayName: string, model: DafnyModel): DafnyGroupEntry => ClearSplitEffectAppCore.__default.MakeGroupEntry(_dafny.Seq.UnicodeFromString(groupName), _dafny.Seq.UnicodeFromString(displayName), model),
  ComputeCrossGroupSummary: (groups: GroupEntry[]): DafnyCrossGroupSummary => ClearSplitEffectAppCore.__default.ComputeCrossGroupSummary(_dafny.Seq.of(...(groups || []).map((x: any) => groupentryFromJson(x)))),
  GetTotalOwed: (summary: DafnyCrossGroupSummary): number => toNumber(ClearSplitEffectAppCore.__default.GetTotalOwed(summary)),
  GetTotalOwes: (summary: DafnyCrossGroupSummary): number => toNumber(ClearSplitEffectAppCore.__default.GetTotalOwes(summary)),
  GetNetBalance: (summary: DafnyCrossGroupSummary): number => toNumber(ClearSplitEffectAppCore.__default.GetNetBalance(summary)),
  GetGroupBalances: (summary: DafnyCrossGroupSummary): GroupBalance[] => seqToArray(ClearSplitEffectAppCore.__default.GetGroupBalances(summary)).map(x => groupbalanceToJson(x)),
  GetGroupBalanceName: (gb: DafnyGroupBalance): string => dafnyStringToJs(ClearSplitEffectAppCore.__default.GetGroupBalanceName(gb)),
  GetGroupBalanceAmount: (gb: DafnyGroupBalance): number => toNumber(ClearSplitEffectAppCore.__default.GetGroupBalanceAmount(gb)),
  InitServerWithMembers: (memberList: string[]): DafnyServerState => ClearSplitEffectAppCore.__default.InitServerWithMembers(_dafny.Seq.of(...(memberList || []).map((x: any) => _dafny.Seq.UnicodeFromString(x)))),
  InitClientFromServer: (server: DafnyServerState): DafnyClientState => ClearSplitEffectAppCore.__default.InitClientFromServer(server),
  InitClient: (version: number, model: DafnyModel): DafnyClientState => ClearSplitEffectAppCore.__default.InitClient(new BigNumber(version), model),
  MakeExpense: (paidBy: string, amount: number, shares: Record<string, number>, shareKeys: string[]): DafnyExpense => ClearSplitEffectAppCore.__default.MakeExpense(_dafny.Seq.UnicodeFromString(paidBy), new BigNumber(amount), ((obj) => { let m = _dafny.Map.Empty; for (const [k, v] of Object.entries(obj || {})) { m = m.update(_dafny.Seq.UnicodeFromString(k), new BigNumber(v)); } return m; })(shares), _dafny.Seq.of(...(shareKeys || []).map((x: any) => _dafny.Seq.UnicodeFromString(x)))),
  MakeSettlement: (from: string, to: string, amount: number): DafnySettlement => ClearSplitEffectAppCore.__default.MakeSettlement(_dafny.Seq.UnicodeFromString(from), _dafny.Seq.UnicodeFromString(to), new BigNumber(amount)),
  ClientLocalDispatch: (client: DafnyClientState, action: DafnyAction): DafnyClientState => ClearSplitEffectAppCore.__default.ClientLocalDispatch(client, action),
  HandleRealtimeUpdate: (client: DafnyClientState, serverVersion: number, serverModel: DafnyModel): DafnyClientState => ClearSplitEffectAppCore.__default.HandleRealtimeUpdate(client, new BigNumber(serverVersion), serverModel),
  ClientAcceptReply: (client: DafnyClientState, newVersion: number, newPresent: DafnyModel): DafnyClientState => ClearSplitEffectAppCore.__default.ClientAcceptReply(client, new BigNumber(newVersion), newPresent),
  ClientRejectReply: (client: DafnyClientState, freshVersion: number, freshModel: DafnyModel): DafnyClientState => ClearSplitEffectAppCore.__default.ClientRejectReply(client, new BigNumber(freshVersion), freshModel),
  ServerDispatch: (server: DafnyServerState, baseVersion: number, action: DafnyAction): DafnyTuple2<DafnyServerState, DafnyReply> => ClearSplitEffectAppCore.__default.ServerDispatch(server, new BigNumber(baseVersion), action),
  ServerVersion: (server: DafnyServerState): number => toNumber(ClearSplitEffectAppCore.__default.ServerVersion(server)),
  ClientModel: (client: DafnyClientState): DafnyModel => ClearSplitEffectAppCore.__default.ClientModel(client),
  ClientVersion: (client: DafnyClientState): number => toNumber(ClearSplitEffectAppCore.__default.ClientVersion(client)),
  PendingCount: (client: DafnyClientState): number => toNumber(ClearSplitEffectAppCore.__default.PendingCount(client)),
  IsAccepted: (reply: DafnyReply): boolean => ClearSplitEffectAppCore.__default.IsAccepted(reply),
  IsRejected: (reply: DafnyReply): boolean => ClearSplitEffectAppCore.__default.IsRejected(reply),
  Balances: (model: DafnyModel): DafnyMap<DafnySeq, DafnyInt> => ClearSplitEffectAppCore.__default.Balances(model),
  GetBalance: (model: DafnyModel, p: string): number => toNumber(ClearSplitEffectAppCore.__default.GetBalance(model, _dafny.Seq.UnicodeFromString(p))),
  Members: (model: DafnyModel): string[] => seqToArray(ClearSplitEffectAppCore.__default.Members(model)).map(x => dafnyStringToJs(x)),
  Expenses: (model: DafnyModel): Expense[] => seqToArray(ClearSplitEffectAppCore.__default.Expenses(model)).map(x => expenseToJson(x)),
  Settlements: (model: DafnyModel): Settlement[] => seqToArray(ClearSplitEffectAppCore.__default.Settlements(model)).map(x => settlementToJson(x)),
  GetFirstPending: (client: DafnyClientState): DafnyAction => ClearSplitEffectAppCore.__default.GetFirstPending(client),
  HasPending: (client: DafnyClientState): boolean => ClearSplitEffectAppCore.__default.HasPending(client),
