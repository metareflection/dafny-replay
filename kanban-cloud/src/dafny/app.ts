...
const App = {
  ...
  // AppCore functions
  EffectInit: (version: number, model: DafnyModel): DafnyEffectState => KanbanEffectAppCore.__default.EffectInit(new BigNumber(version), model),
  EffectStep: (es: DafnyEffectState, event: DafnyEvent): DafnyTuple2<DafnyEffectState, DafnyCommand> => KanbanEffectAppCore.__default.EffectStep(es, event),
  EffectIsOnline: (es: DafnyEffectState): boolean => KanbanEffectAppCore.__default.EffectIsOnline(es),
  EffectIsIdle: (es: DafnyEffectState): boolean => KanbanEffectAppCore.__default.EffectIsIdle(es),
  EffectHasPending: (es: DafnyEffectState): boolean => KanbanEffectAppCore.__default.EffectHasPending(es),
  EffectPendingCount: (es: DafnyEffectState): number => toNumber(KanbanEffectAppCore.__default.EffectPendingCount(es)),
  EffectGetClient: (es: DafnyEffectState): DafnyClientState => KanbanEffectAppCore.__default.EffectGetClient(es),
  EffectGetServerVersion: (es: DafnyEffectState): number => toNumber(KanbanEffectAppCore.__default.EffectGetServerVersion(es)),
  EffectUserAction: (action: DafnyAction): DafnyEvent => KanbanEffectAppCore.__default.EffectUserAction(action),
  EffectDispatchAccepted: (version: number, model: DafnyModel): DafnyEvent => KanbanEffectAppCore.__default.EffectDispatchAccepted(new BigNumber(version), model),
  EffectDispatchConflict: (version: number, model: DafnyModel): DafnyEvent => KanbanEffectAppCore.__default.EffectDispatchConflict(new BigNumber(version), model),
  EffectDispatchRejected: (version: number, model: DafnyModel): DafnyEvent => KanbanEffectAppCore.__default.EffectDispatchRejected(new BigNumber(version), model),
  EffectNetworkError: (): DafnyEvent => KanbanEffectAppCore.__default.EffectNetworkError(),
  EffectNetworkRestored: (): DafnyEvent => KanbanEffectAppCore.__default.EffectNetworkRestored(),
  EffectManualGoOffline: (): DafnyEvent => KanbanEffectAppCore.__default.EffectManualGoOffline(),
  EffectManualGoOnline: (): DafnyEvent => KanbanEffectAppCore.__default.EffectManualGoOnline(),
  EffectTick: (): DafnyEvent => KanbanEffectAppCore.__default.EffectTick(),
  EffectIsNoOp: (cmd: DafnyCommand): boolean => KanbanEffectAppCore.__default.EffectIsNoOp(cmd),
  EffectIsSendDispatch: (cmd: DafnyCommand): boolean => KanbanEffectAppCore.__default.EffectIsSendDispatch(cmd),
  EffectGetBaseVersion: (cmd: DafnyCommand): number => toNumber(KanbanEffectAppCore.__default.EffectGetBaseVersion(cmd)),
  EffectGetAction: (cmd: DafnyCommand): DafnyAction => KanbanEffectAppCore.__default.EffectGetAction(cmd),
  MakeClientState: (baseVersion: number, present: DafnyModel, pending: Action[]): DafnyClientState => KanbanEffectAppCore.__default.MakeClientState(new BigNumber(baseVersion), present, _dafny.Seq.of(...(pending || []).map((x: any) => actionFromJson(x)))),
  Init: (): DafnyServerState => KanbanEffectAppCore.__default.Init(),
  InitServerWithModel: (initModel: DafnyModel): DafnyServerState => KanbanEffectAppCore.__default.InitServerWithModel(initModel),
  InitClientFromServer: (server: DafnyServerState): DafnyClientState => KanbanEffectAppCore.__default.InitClientFromServer(server),
  ClientLocalDispatch: (client: DafnyClientState, action: DafnyAction): DafnyClientState => KanbanEffectAppCore.__default.ClientLocalDispatch(client, action),
  HandleRealtimeUpdate: (client: DafnyClientState, serverVersion: number, serverModel: DafnyModel): DafnyClientState => KanbanEffectAppCore.__default.HandleRealtimeUpdate(client, new BigNumber(serverVersion), serverModel),
  ClientAcceptReply: (client: DafnyClientState, newVersion: number, newPresent: DafnyModel): DafnyClientState => KanbanEffectAppCore.__default.ClientAcceptReply(client, new BigNumber(newVersion), newPresent),
  Sync: (server: DafnyServerState): DafnyClientState => KanbanEffectAppCore.__default.Sync(server),
  ServerVersion: (server: DafnyServerState): number => toNumber(KanbanEffectAppCore.__default.ServerVersion(server)),
  ServerModel: (server: DafnyServerState): DafnyModel => KanbanEffectAppCore.__default.ServerModel(server),
  AuditLength: (server: DafnyServerState): number => toNumber(KanbanEffectAppCore.__default.AuditLength(server)),
  PendingCount: (client: DafnyClientState): number => toNumber(KanbanEffectAppCore.__default.PendingCount(client)),
  ClientModel: (client: DafnyClientState): DafnyModel => KanbanEffectAppCore.__default.ClientModel(client),
  ClientVersion: (client: DafnyClientState): number => toNumber(KanbanEffectAppCore.__default.ClientVersion(client)),
  IsAccepted: (reply: DafnyReply): boolean => KanbanEffectAppCore.__default.IsAccepted(reply),
  IsRejected: (reply: DafnyReply): boolean => KanbanEffectAppCore.__default.IsRejected(reply),
