...
import { backend, isBackendConfigured, signIn, signUp, signInWithGoogle, signOut } from './backend/index.ts'
  ...
  return (
    <>
      <div className="header">
        <div>
          <h1>Kanban</h1>
          <p className="subtitle">Dafny-verified collaborative kanban</p>
        </div>
